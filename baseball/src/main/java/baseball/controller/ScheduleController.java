...
public class ScheduleController {
	...
	@ModelAttribute("kindArr1")
	public ArrayList<String[]> kindArr1() {
		ArrayList<String[]> res = new ArrayList<>();
		res.add(new String[] { "2018", "2018" });
		res.add(new String[] { "2017", "2017" });
		res.add(new String[] { "2016", "2016" });

		return res;

	}
	
	@ModelAttribute("kindArr2")
	public ArrayList<String[]> kindArr2() {
		ArrayList<String[]> res = new ArrayList<>();
		res.add(new String[] { "1", "1" });
		res.add(new String[] { "2", "2" });
		res.add(new String[] { "3", "3" });
		res.add(new String[] { "4", "4" });
		res.add(new String[] { "5", "5" });
		res.add(new String[] { "6", "6" });
		res.add(new String[] { "7", "7" });
		res.add(new String[] { "8", "8" });
		res.add(new String[] { "9", "9" });
		res.add(new String[] { "10", "10" });
		res.add(new String[] { "11", "11" });
		res.add(new String[] { "12", "12" });
